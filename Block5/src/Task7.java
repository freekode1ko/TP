...
public class Task7
{
	...
	private static String numToRus(int Num) 
	{
        ...
        if (num.length() == 3) 
        {
            ...
            switch (Character.toString(num.charAt(1))) {
                case "0" : res += " " + map.get(Character.toString(num.charAt(2)));
                case "1" : res += " " + map.get(Character.toString(num.charAt(2))).substring(0, map.get(Character.toString(num.charAt(2))).length() - 1) + "надцать";
                case "2" : res += " " + map.get(Character.toString(num.charAt(1))) + "дцать "+ map.get(Character.toString(num.charAt(2)));
                case "3" : res += " " + map.get(Character.toString(num.charAt(1))) + "дцать "+ map.get(Character.toString(num.charAt(2)));
                case "4" : res += " сорок " + map.get(Character.toString(num.charAt(2)));
                case "9" : res += " девяносто " + map.get(Character.toString(num.charAt(2)));
                default : res += " " + map.get(Character.toString(num.charAt(1))) + "десят "+ map.get(Character.toString(num.charAt(2)));
            }
        } 
        else if (num.length() == 2) 
        {
            ...
            switch (Character.toString(num.charAt(0))) 
            {
                case "1" : res += map.get(Character.toString(num.charAt(1))).substring(0, map.get(Character.toString(num.charAt(1))).length() - 1) + "надцать";
                case "2" : res += map.get(Character.toString(num.charAt(0))) + "дцать" + map.get(Character.toString(num.charAt(1)));
                case "3" : res += map.get(Character.toString(num.charAt(0))) + "дцать" + map.get(Character.toString(num.charAt(1)));
